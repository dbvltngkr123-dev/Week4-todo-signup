...
- **할 일 수정**: '수정' 버튼을 누르면 인라인으로 텍스트를 바꿀 수 있습니다. (Enter=저장, Esc=취소)
...
## 사용 방법
1. 입력창에 할 일을 입력합니다. (최대 100자, 이미 등록된 문구는 추가 불가)
2. '추가' 버튼을 클릭하거나 Enter를 누르면 목록에 추가됩니다.
3. 체크박스를 클릭하면 완료 상태로 표시됩니다(취소선).
4. '수정' 버튼을 누르면 텍스트를 바로 고칠 수 있습니다. (Enter=저장, Esc=취소, '저장'/'취소' 버튼도 가능)
